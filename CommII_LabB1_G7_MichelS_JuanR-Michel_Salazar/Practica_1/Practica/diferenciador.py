...
import diferenciador_epy_block_0_1_0 as epy_block_0_1_0  # embedded python block
import diferenciador_epy_block_1_0 as epy_block_1_0  # embedded python block
import sip
import threading
...
class diferenciador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_throttle2_0_0, 0), (self.epy_block_0_1_0, 0))
        ...
        self.connect((self.epy_block_1_0, 0), (self.qtgui_time_sink_x_0_0_1, 0))
