...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica4_OOK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica4_OOK")
        ...
        self._fd_range = qtgui.Range(0, samp_rate/8, samp_rate/1000, Rb*4, 200)
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, Rb, True, 0 if "auto" == "auto" else max( int(float(0.1) * Rb) if "auto" == "time" else int(0.1), 1) )
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.blocks_multiply_const_vxx_0_1, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.qtgui_time_sink_x_0_1_0, 0))
    ...
    def set_Rb(self, Rb):
        ...
        self.set_fd(self.Rb*4)
        self.set_samp_rate(self.Rb*self.Sps)
        self.blocks_throttle2_0.set_sample_rate(self.Rb)
