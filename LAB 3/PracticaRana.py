...
# Title: Practica 2
# Author: Michel_Salazar_Juan_Rojas
...
import PracticaRana_epy_block_0 as epy_block_0  # embedded python block
import numpy as np
import sip
import threading
...
class PracticaRana(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PracticaRana")
        ...
        self.Sps = Sps = len(h)
        self.Rb = Rb = 32000
        self.samp_rate_0 = samp_rate_0 = Rb*Sps
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\mdsal\\OneDrive\\Escritorio\\CARPETAS_SEMESTRES\\Semestre nueve\\COMUNICACIONES II\\LABORATORIOS\\LAB 3\\Pract3\\rana.jpg', True, 0, 0)
    ...
    def set_Sps(self, Sps):
        self.Sps = Sps
        self.set_samp_rate_0(self.Rb*self.Sps)
...
def main(top_block_cls=PracticaRana, options=None):
