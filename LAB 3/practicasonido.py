...
import numpy as np
import practicasonido_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class practicasonido(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "practicasonido")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\mdsal\\OneDrive\\Escritorio\\CARPETAS_SEMESTRES\\Semestre nueve\\COMUNICACIONES II\\LABORATORIOS\\LAB 3\\Pract3\\sonido.wav', True, 0, 0)
...
def main(top_block_cls=practicasonido, options=None):
