...
class bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = qtgui.Range(0, samp_rate/8, samp_rate/1000, Rb*2, 200)
        ...
        self.qtgui_freq_sink_x_0_1.set_y_axis((-65), (-35))
        ...
        self.Menu_grid_layout_2.addWidget(self._qtgui_freq_sink_x_0_1_win, 2, 1, 1, 1)
        for r in range(2, 3):
        ...
        self.Menu_grid_layout_3.addWidget(self._qtgui_const_sink_x_0_0_win, 3, 1, 1, 1)
        for r in range(3, 4):
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_complex_to_magphase_0, 0))
