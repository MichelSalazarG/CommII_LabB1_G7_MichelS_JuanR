...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Pn_range = qtgui.Range(0.00001, 0.1, 0.1/100, 0.00001, 200)
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, Pn, 0)
    ...
    def set_Pn(self, Pn):
        self.Pn = Pn
        self.analog_noise_source_x_0.set_amplitude(self.Pn)
