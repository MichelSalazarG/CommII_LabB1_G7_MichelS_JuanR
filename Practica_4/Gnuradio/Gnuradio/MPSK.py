...
import MPSK_epy_block_1 as epy_block_1  # embedded python block
import math
import sip
import threading
...
class MPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.blk(N_ensayos=1000000, Ec=0, N_FFT=1024, Titulo="PSD", Tmax=6e-6, Fmuestreo=samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.epy_block_1.Fmuestreo = self.samp_rate
