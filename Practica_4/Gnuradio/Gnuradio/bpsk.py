...
import bpsk_epy_block_0_1 as epy_block_0_1  # embedded python block
import math
import sip
import threading
...
class bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (1+0j, 0.77+0.77j,0+1j, -0.77-0.77j,-1+0j, -0.77+0.77j,0-1j, 0.77-0.77j)
